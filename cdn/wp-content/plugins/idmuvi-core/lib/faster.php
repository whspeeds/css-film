...
function idmuvi_disable_emojis() {
	...
	if ( isset( $idmuv_other['other_remove_emoji_script'] ) && ! empty( $idmuv_other['other_remove_emoji_script'] ) ) {
...
function idmuvi_core_disable_embeds_init() {
	...
	if ( isset( $idmuv_other['other_wp_head_tag'] ) && ! empty( $idmuv_other['other_wp_head_tag'] ) ) {
		// option, section, default.
