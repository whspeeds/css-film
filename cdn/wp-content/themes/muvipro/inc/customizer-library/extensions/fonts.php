...
if ( ! function_exists( 'customizer_library_get_font_choices' ) ) :
	...
	function customizer_library_get_all_fonts() {
		$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'muvipro' ) ) ) );
		$standard_fonts = customizer_library_get_standard_fonts();
		$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'muvipro' ) ) ) );
...
if ( ! function_exists( 'customizer_library_get_google_font_subsets' ) ) :
	...
	function customizer_library_get_google_font_subsets() {
		return array(
			'all'          => __( 'All', 'muvipro' ),
			'cyrillic'     => __( 'Cyrillic', 'muvipro' ),
			'cyrillic-ext' => __( 'Cyrillic Extended', 'muvipro' ),
			'devanagari'   => __( 'Devanagari', 'muvipro' ),
			'greek'        => __( 'Greek', 'muvipro' ),
			'greek-ext'    => __( 'Greek Extended', 'muvipro' ),
			'khmer'        => __( 'Khmer', 'muvipro' ),
			'latin'        => __( 'Latin', 'muvipro' ),
			'latin-ext'    => __( 'Latin Extended', 'muvipro' ),
			'vietnamese'   => __( 'Vietnamese', 'muvipro' ),
		);
	}
endif;
...
if ( ! function_exists( 'customizer_library_get_standard_fonts' ) ) :
	...
	function customizer_library_get_standard_fonts() {
		return array(
			'serif'      => array(
				'label' => _x( 'Serif', 'font style', 'muvipro' ),
				'stack' => 'Georgia,Times,"Times New Roman",serif',
			),
			'sans-serif' => array(
				'label' => _x( 'Sans Serif', 'font style', 'muvipro' ),
				'stack' => '"Helvetica Neue",sans-serif',
			),
			'monospace'  => array(
				'label' => _x( 'Monospaced', 'font style', 'muvipro' ),
				'stack' => 'Monaco,"Lucida Sans Typewriter","Lucida Typewriter","Courier New",Courier,monospace',
			),
			'helvetica'  => array(
				'label' => _x( 'Helvetica', 'font style', 'muvipro' ),
